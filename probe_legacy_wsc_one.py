...
try:
 r=s.get('https://stats.nba.com/stats/videoevents',params={'GameEventID':EID,'GameID':GID},timeout=15)
 ...
 if r.ok:
  ...
  x=s.get(f'https://secure.nba.com/video/wsc/league/{uuid}.secure.xml',timeout=15)
